	...
	<header id="header" class="header header-style-1">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{asset('asset/woman.png')}}" alt="mercado"></a>
				...
				<div class="mainbar">
					<ul class="navbarr">
					@if(Route::currentRouteName()=='OnlineFashionStore.com')
								...
								<div class="item-content">
									<div class="wrap-contact-detail">
										<ul>
											<li>
											<div class="wrap-logo-top left-section">
						            	        <a href="/" class="link-to-home"><img src="{{asset('asset/woman.png')}}" style="height:70px;" alt="mercado"></a>
