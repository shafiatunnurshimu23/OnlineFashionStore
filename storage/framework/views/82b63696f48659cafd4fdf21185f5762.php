...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"  href="asset/woman.png">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="<?php echo e(asset('asset/woman.png')); ?>" alt="mercado"></a>
							<p style="color:#846174;padding-left:20px;font-size:14px; font-family:cursive;"><strong>Online Fashion Store</strong></p>
						</div>

						<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('header-search-component')->html();
} elseif ($_instance->childHasBeenRendered('RRKbO2m')) {
    $componentId = $_instance->getRenderedChildComponentId('RRKbO2m');
    $componentTag = $_instance->getRenderedChildComponentTagName('RRKbO2m');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RRKbO2m');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('RRKbO2m', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('NBuxM1g')) {
    $componentId = $_instance->getRenderedChildComponentId('NBuxM1g');
    $componentTag = $_instance->getRenderedChildComponentTagName('NBuxM1g');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NBuxM1g');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('NBuxM1g', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('UlPkjEt')) {
    $componentId = $_instance->getRenderedChildComponentId('UlPkjEt');
    $componentTag = $_instance->getRenderedChildComponentTagName('UlPkjEt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('UlPkjEt');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('UlPkjEt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
				...
				<div class="mainbar">
					<ul class="navbarr">
					<?php if(Route::currentRouteName()=='OnlineFashionStore.com'): ?>
								...
								<div class="item-content">
									<div class="wrap-contact-detail">
										<ul>
											<li>
											<div class="wrap-logo-top left-section">
						            	        <a href="/" class="link-to-home"><img src="<?php echo e(asset('asset/woman.png')); ?>" style="height:70px;" alt="mercado"></a>
							                    <p style="color:#846174;font-size:10px; font-family:cursive;"><strong>Online Fashion Store</strong></p>
						                    </div>
											</li>
										
											<li>
												<i class="fa fa-map-marker" aria-hidden="true"></i>
												<address>House - 1/1, Block # A, Asad Gate,Lalmatia
                                                <br>
                                                 Mirpur Road, Dhanmondi,Dhaka- 1207, Bangladesh<br>
											...
											<li>
												...
												<p class="contact-txt">contact@onlinefashionstore.com</p>
											</li>											
										</ul>
									</div>
								</div>
			...
			<div class="coppy-right-box" style="margin-top: 15px">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2023 onlinefashionstore. All rights reserved</p>
					</div>
...
</html><?php /**PATH C:\xampp\htdocs\OnlineFashionStore - Copy\resources\views/layouts/base.blade.php ENDPATH**/ ?>