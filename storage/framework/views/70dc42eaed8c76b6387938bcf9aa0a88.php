...
} elseif ($_instance->childHasBeenRendered('2rwh3Xq')) {
    $componentId = $_instance->getRenderedChildComponentId('2rwh3Xq');
    $componentTag = $_instance->getRenderedChildComponentTagName('2rwh3Xq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2rwh3Xq');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('2rwh3Xq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('drieP07')) {
    $componentId = $_instance->getRenderedChildComponentId('drieP07');
    $componentTag = $_instance->getRenderedChildComponentTagName('drieP07');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('drieP07');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('drieP07', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('SXztsOq')) {
    $componentId = $_instance->getRenderedChildComponentId('SXztsOq');
    $componentTag = $_instance->getRenderedChildComponentTagName('SXztsOq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SXztsOq');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('SXztsOq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\OnlineFashionStore - Copy\resources\views/layouts/guest.blade.php ENDPATH**/ ?>