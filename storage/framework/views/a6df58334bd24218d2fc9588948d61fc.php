            ...
            <div class="wrap-list-cate">
                ...
                <ul class="list-cate">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="level-1" data-id="<?php echo e($category->id); ?>">
                        <a href="<?php echo e(route('product.category', ['category_slug'=>$category->slug])); ?>" class="cate-link">
...
</div><?php /**PATH C:\xampp\htdocs\OnlineFashionStore - Copy\resources\views/livewire/header-search-component.blade.php ENDPATH**/ ?>