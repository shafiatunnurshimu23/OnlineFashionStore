...
} elseif ($_instance->childHasBeenRendered('gBwZJIc')) {
    $componentId = $_instance->getRenderedChildComponentId('gBwZJIc');
    $componentTag = $_instance->getRenderedChildComponentTagName('gBwZJIc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gBwZJIc');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('gBwZJIc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('zN3rM1R')) {
    $componentId = $_instance->getRenderedChildComponentId('zN3rM1R');
    $componentTag = $_instance->getRenderedChildComponentTagName('zN3rM1R');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zN3rM1R');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('zN3rM1R', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('VQ2ROWP')) {
    $componentId = $_instance->getRenderedChildComponentId('VQ2ROWP');
    $componentTag = $_instance->getRenderedChildComponentTagName('VQ2ROWP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VQ2ROWP');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('VQ2ROWP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\OnlineFashionStore\resources\views/layouts/base.blade.php ENDPATH**/ ?>