                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item active" id="add_infomation">
                                <table class="shop_attributes">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Color :</th><td class="product_weight"><?php echo e($product->color); ?></td>
                                        </tr>
                                        <tr>
                                            <th>Materials :</th><td class="product_dimensions"><?php echo e($product->materials); ?></td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">01 review for <span><?php echo e($product->name); ?></span></h2>
                                        <ol class="commentlist">
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container"> 
                                                    <img alt="" src="<?php echo e(asset('assets/images/admin1.jpg')); ?>" height="80" width="80">
                                ...
                                <div class="product product-style-2 equal-elem">
                                    <div class="product-thumnail">
                                        <a href="<?php echo e(route('product.details', ['slug'=>$r_product->slug])); ?>" title="<?php echo e($r_product->name); ?>">
                                            <figure><img src="<?php echo e(asset('asset/product_image')); ?>/<?php echo e($r_product->image); ?>" width="214" height="214" alt="<?php echo e($r_product->name); ?>"></figure>
                                        </a>
...
<!--main area--><?php /**PATH C:\xampp\htdocs\OnlineFashionStore\resources\views/livewire/details-component.blade.php ENDPATH**/ ?>