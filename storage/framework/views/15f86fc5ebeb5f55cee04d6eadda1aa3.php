	...
	<div class="container">
		...
		<div class="wrap-breadcrumb">
			<ul>
				...
				<li class="item-link"><span>Cloths and Accessories</span></li>
			</ul>
		</div>
		<div class="row">
			...
			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
				...
				<div class="banner-shop">
					<a href="#" class="banner-link">
						<figure><img src="<?php echo e(asset('asset/banner/salebanner')); ?>.jpg" alt="" style="width:100%; height: 2in;"></figure>
					</a>
				</div>

				<div class="wrap-shop-control">

					<h1 class="shop-title">Cloths and Accessories</h1>
                                    ...
                                    <div class="product product-style-3 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="<?php echo e(route('product.details', ['slug'=>$product->slug])); ?>" title="<?php echo e($product->name); ?>">
                                                <figure><img src="<?php echo e(asset('asset/product_image')); ?>/<?php echo e($product->image); ?>" alt="<?php echo e($product->name); ?>"style="height:320px;"></figure>
                                            </a>
                                        </div>
			...
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
				...
				<div class="widget mercado-widget filter-widget">
					<div class="widget-content">
						...
						<a href="/product-category/accessories" class="link-banner banner-effect-1">
							<figure><img src="<?php echo e(asset('asset/side_banner')); ?>.webp" width="270" height="331" alt=""></figure></a>
						</div>
					</div>
				</div><!-- Size -->
...
<?php /**PATH C:\xampp\htdocs\OnlineFashionStore - Copy\resources\views/livewire/search-component.blade.php ENDPATH**/ ?>