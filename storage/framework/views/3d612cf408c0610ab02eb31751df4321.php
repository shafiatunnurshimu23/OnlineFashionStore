...
} elseif ($_instance->childHasBeenRendered('L3x3n8D')) {
    $componentId = $_instance->getRenderedChildComponentId('L3x3n8D');
    $componentTag = $_instance->getRenderedChildComponentTagName('L3x3n8D');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('L3x3n8D');
} else {
    $response = \Livewire\Livewire::mount('header-search-component');
    $html = $response->html();
    $_instance->logRenderedChild('L3x3n8D', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('ewcgPdR')) {
    $componentId = $_instance->getRenderedChildComponentId('ewcgPdR');
    $componentTag = $_instance->getRenderedChildComponentTagName('ewcgPdR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ewcgPdR');
} else {
    $response = \Livewire\Livewire::mount('wishlist-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('ewcgPdR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Ew7iA2N')) {
    $componentId = $_instance->getRenderedChildComponentId('Ew7iA2N');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ew7iA2N');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ew7iA2N');
} else {
    $response = \Livewire\Livewire::mount('cart-count-component');
    $html = $response->html();
    $_instance->logRenderedChild('Ew7iA2N', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH C:\xampp\htdocs\OnlineFashionStore\resources\views/layouts/guest.blade.php ENDPATH**/ ?>